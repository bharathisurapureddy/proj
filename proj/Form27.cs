...
namespace proj
{
    public partial class Form27 : Form
    {
        ...
        private void LoadData()
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand("select * from medhouse", conn);
            ...
            conn.Close();
            MessageBox.Show("Moving to Available house data ...", "CONFORMATION", MessageBoxButtons.OK, MessageBoxIcon.Information);
